...
export default class Main extends Component {
    ...
    render() {
        return (
                ...
                <Text
                onPress={()=>{
                UMNative.onEvent('Himi',(callBackEvents)=>{
                                 
                                         Alert.alert('返回值'+callBackEvents);
                ...
                <Text style={styles.titleStyle}>Umeng Dplus demo</Text>
                ...
                <Text
                onPress={()=>{
                UMNative.registerSuperProperty('name','Himi');
                UMNative.registerSuperProperty('age','10');
                }}
...
AppRegistry.registerComponent('demo', () => Main);